...
<div class="row my-3">
    ...
    <div class="col-8">
        <div v-pre class="documenter h-100">
            <h4>route</h4>
{!! App\Documenter::showCode("Modules/Demo/Components/routes.php", false, '^Route::get\(\'demo\/article\/view\/.*}\);$') !!}
        </div>
    </div>
</div>
<div class="row">
    <div class="col-5">
        <div v-pre class="documenter">
            <h4>component</h4>
{!! App\Documenter::showCode("Modules/Demo/Components/Articles/ArticlesView.php") !!}
        </div>
    </div>
    <div class="col-7">
        <div v-pre class="documenter">
            <h4>view</h4>
{!! App\Documenter::showCode("Modules/Demo/Components/Articles/views/articles_view.blade.php", true) !!}
        </div>
    </div>
</div>
